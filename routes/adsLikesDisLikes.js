...
router.post("/getDislikes", (req, res) => {
 ...
 // new like and notifying of post owner
router.post("/upLike", (req, res) => {

    let variable = {}
    if (req.body.videoId) {
        variable = { videoId: req.body.videoId, userId: req.body.userId, userTo: req.body.userTo }
    } else {
    ...
    like.save((err, likeResult) => {
        if (err)  return res.json({ success: false, err: "Failed to save like!"});           
